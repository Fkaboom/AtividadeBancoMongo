...
public class MongoClientConnectionExample {
    ...
    public static void main(String[] args) {
        SpringApplication.run(MongoClientConnectionExample.class, args);
    }

    String uri = "mongodb+srv://felipe:felipe@meubanco.nobzstt.mongodb.net/?retryWrites=true&w=majority";
